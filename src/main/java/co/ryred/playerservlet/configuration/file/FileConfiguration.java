package co.ryred.playerservlet.configuration.file;

import co.ryred.playerservlet.configuration.Configuration;
import co.ryred.playerservlet.configuration.InvalidConfigurationException;
import co.ryred.playerservlet.configuration.MemoryConfiguration;
...
public abstract class FileConfiguration extends MemoryConfiguration
{
	...
	/**
	 * Creates an empty {@link co.ryred.playerservlet.configuration.file.FileConfiguration} with no default values.
	 */
	...
	/**
	 * Creates an empty {@link co.ryred.playerservlet.configuration.file.FileConfiguration} using the specified {@link
	...
	/**
	 * Saves this {@link co.ryred.playerservlet.configuration.file.FileConfiguration} to the specified location.
	 * <p>
	...
	/**
	 * Saves this {@link co.ryred.playerservlet.configuration.file.FileConfiguration} to a string, and returns it.
	 *
	...
	/**
	 * Loads this {@link co.ryred.playerservlet.configuration.file.FileConfiguration} from the specified location.
	 * <p>
	...
	/**
	 * Loads this {@link co.ryred.playerservlet.configuration.file.FileConfiguration} from the specified stream.
	 * <p>
	 * All the values contained within this configuration will be removed,
	 * leaving only settings and defaults, and the new values will be loaded
	...
	/**
	 * Loads this {@link co.ryred.playerservlet.configuration.file.FileConfiguration} from the specified reader.
	 * <p>
	 * All the values contained within this configuration will be removed,
	 * leaving only settings and defaults, and the new values will be loaded
	 * from the given stream.
	...
	/**
	 * Loads this {@link co.ryred.playerservlet.configuration.file.FileConfiguration} from the specified string, as
	...
	/**
	 * Compiles the header for this {@link co.ryred.playerservlet.configuration.file.FileConfiguration} and returns the
	 * result.
	 * <p>
